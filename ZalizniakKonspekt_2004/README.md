...
## Проверка утверждений (реестр `claims.yml`) — ПОЛНОСТЬЮ ВЫРАБОТАН, ВСЕ 17 TRUE (15-07-2026)
...
согласуется с редкостью, но не даёт точного отношения. **Полный слив (KZ-3..KZ-17, Fable 5 `claude-fable-5`, H797):** сначала 10 неблокированных
кандидатов, затем — после ПОСТРОЙКИ недостающего инструмента — и пять ригведских дробей:
реестр теперь **17 проверенных, все 17 TRUE** (0 OVERSTATED · 0 FALSE · 0 UNTESTABLE),
очередь пуста. Новый инструмент периодной изоляции —
[rigveda_kz_fractions.py](https://github.com/gasyoun/SanskritGrammar/blob/main/ZalizniakKonspekt_2004/rigveda_kz_fractions.py)
поверх закреплённого SQLite-мастера VisualDCS (снимок dcs-conllu `04e0778`, тот же, что у
пилота H953) — измерил дроби Зализняка **поразительно точно**: заявлено 1/3 — измерено
33,2 % (-āsas, до десятой доли процента); 7/8 — 84,9 %; 3/5 — 65,6 %; 1/2 — 42,3 %;
5/6 — 76,9 %. Дроби ручного подсчёта ведологической эпохи воспроизведены тредбанком
2026 года. Тот же инструмент перевёл из UNTESTABLE в измеренное TRUE и оба утверждения
веды-vs-эпос: инъюнктив — 7,3 % личных форм Ригведы против 0,5 % Махабхараты (≈ в 15 раз;
оптатив — зеркально; KZ-11), причастная предикация — 1,7 % глагольных вершин предложения
в Ригведе против 11,8–18,4 % в эпических выборках (KZ-12) — **первая измеренная точка на
дуге «стиль I → стиль II»**, которую очерк 1978 формулирует с классического конца (§207).
Нуль-флаговый профиль Зализняка теперь охватывает обе его книги: **91 проверенное
утверждение, ни одного фактического флага** (пары вердиктов KZ-5=OCH-43, KZ-2=OCH-42,
KZ-6=OCH-64; прецедент судимой без разметки диахронии — KZ-7 по Уитни §§1246-1247). Методику см. в README соседей:
