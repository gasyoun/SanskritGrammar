...
| Errata (per edition) | [`errata.yml`](https://github.com/gasyoun/SanskritGrammar/blob/main/KocherginaUchebnik_1998/errata.yml) → [`ERRATA.mdx`](https://github.com/gasyoun/SanskritGrammar/blob/main/KocherginaUchebnik_1998/ERRATA.mdx), `/errata` skill | 🟡 system built; entry shape carries the `edition` field (H807, 16-07-2026); list deliberately **empty** — awaiting a printed sheet or an edition diff |
