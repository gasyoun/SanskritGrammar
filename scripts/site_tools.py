...
optimization, and build verification against the canonical root configuration.
...
# ------------------------------------------------------------------- site ---
def site(root):
    """Build the one canonical site; dependency installation is an explicit caller step."""
