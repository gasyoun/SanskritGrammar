...
DATA = ROOT / "sangram" / "articles" / "tatpurusa" / "data"
SEED = 20260715
N_BOOT = 2000
THRESHOLD = 0.7
...
def main():
    ...
    fine_ids = [i for i in ids if a[i]["coarse"] == "tatpurusa" and b[i]["coarse"] == "tatpurusa"]
    ...
    with open(DATA / "validation_verdicts.tsv", "w", encoding="utf-8", newline="") as f:
        ...
        for i in ids:
            ...
            cag = ca_ == cb_
            fag = (fa_ == fb_) if (ca_ == "tatpurusa" and cb_ == "tatpurusa") else ""
