...
def render_book(work, entries, book_dir, synthesis=""):
    ...
    lines = header + [
        f"_Generated: {ddmmyyyy(TODAY)} · {n} claims registered · {verdicted} verdicted · "
        f"{flagged} flagged (overstated/false or presentation issue)_",
        "",
    ...
    return "\n".join(lines), n, verdicted, flagged
...
def main():
    ...
    for yml in ymls:
        ...
        md, n, verdicted, flagged = render_book(work, entries, book_dir, synthesis)
