"""H1613 freeze-exit probe for SG-MO-025 (art:infinitive).
...
RESULT = {
    ...
    "instrument_script": "scripts/sg_mo_025_infinitive.py",
    ...
    "verdict": "escalated",
    "do_not": "Do not invent an infinitive-specific kill threshold.",
