...
**Audience.** Every session writing or revising Sangram article prose (the pre-PR checklist in § 5 is mandatory); the author (visa on the guide itself); future consumers outside the Sangram series (Kochergina methodichka).

**Provenance.** Fable 5 (`claude-fable-5`), 16-07-2026, handoff [H1003](https://github.com/gasyoun/Uprava/blob/main/handoffs/H1003-Fable_SanskritGrammar_sangram-style-guide-rusgram-etalon_16.07.26.md), from the P3 visa-sheet notes (cards B1 + A7, MG, 15-07-2026). Etalon study: two rusgram.ru articles («Будущее время» N. M. Stoynova 2018; «Творительный падеж»), point-read per the handoff guardrail (no mass scraping). Demo rewrite: perfect § 6 in the same PR. The guide itself is gated on the author's visa (review-sheet `sangram-prose-style-guide-visa_16.07.26`, local-only in `SanskritGrammar\review\`).
