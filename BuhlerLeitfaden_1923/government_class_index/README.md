...
- The **government lexicon** is a candidate valence resource for the Sanskrit parser / treebank
  stack — no equivalent machine-readable Rektion lexicon exists in the org crosswalk.
