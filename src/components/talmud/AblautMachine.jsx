    ...
    <div className={styles.widget}>
      ...
      <p className={styles.caption}>
        {example ? (
          ...
          <>
            Позиция окончания задаёт ступень (Поз. 1 → слабая, Поз. 2 → гуна,
            Поз. 3 → вриддхи, для полноизменяемого типа «I», Табл. 5 руководства).
            В скобках Таблицы 2 — алломорф перед гласной; переключите «перед
            гласной», чтобы увидеть его.
          </>
        )}
      </p>
    </div>
