...
- [x] **Wave 2 — auto-drill generation with verified answer keys (RQ2).** ✅ Done 25-09-2026 — [attested-sentence cloze drills](https://github.com/gasyoun/SanskritGrammar/blob/main/sangram/data/attested_cloze_drills/README.md) close the third of RQ2's three named drill shapes (sandhi-split and paradigm-fill had already shipped). Self-contained builder (only the pinned VisualDCS DCS snapshot, no kosha/vidyut dependency), tests, widget + trainer page. [PR #978](https://github.com/gasyoun/SanskritGrammar/pull/978).
