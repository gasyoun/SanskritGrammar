...
| `METHODICHKA_VISA_APPLY.md` | 🟡 pending — [PR #541](https://github.com/gasyoun/SanskritGrammar/pull/541) open | [H1674](https://github.com/gasyoun/Uprava/blob/main/handoffs/H1674-Sonnet_SanskritGrammar_runbook-methodichka-visa-apply_26.07.26.md) | Methodichka residual visa-apply checklist runbook (procedure; apply itself remains H1454/H1615). |
...
Rows for H1674–H1676 will get their filename + a full-blob-URL link and flip to ✅ merged as
