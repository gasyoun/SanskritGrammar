...
| W1-E a65 claim notes | Re-adjudicated 25-09-2026 (A10): the 6 rows were stale, not actually open — [H1276](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H1276-Fable_SanskritGrammar_sangram-apply-notes-a65-claims_18.07.26.md) already wrote all 6 into `claims.yml` via merged [SanskritGrammar PR #502](https://github.com/gasyoun/SanskritGrammar/pull/502) (21-07-2026); the ledger row was simply never refreshed after that merge. Now: HB-100/HB-57/HK-15/HK-34/HK-5 `APPLIED`, HK-4a `ESCALATED` (genuine, `Q2607-146` still open), `MO021-09` `APPLIED` (both companion methodichkas cite it directly); HK-4b already `APPLIED` | **Shipped** — [PR TBD](#), ledger refreshed |
