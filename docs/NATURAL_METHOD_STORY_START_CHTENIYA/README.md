...
## Syllabus (5 chapters planned, 3 drafted)
...
| 4 | (planned) श्लोकाः — metre chapter around the W4 Karaoke verse set | W4 | 🟡 planned |
| 5 | (planned) सुभाषितानि — into the literature band, ladder ending | W5 | 🟡 planned |
...
| W5 literature band | [kosha `subhashita_beginner_pack.json`](https://github.com/gasyoun/kosha/blob/main/data/subhashita/subhashita_beginner_pack.json) | Chapters 4–5 (planned) |
...
Per the handoff, drafting **stops after these two passes** — further polish belongs to
the human editorial visa, not to more agent passes.
