...
### Fixed (flagged, not yet applied)
- **Contradiction found: morphological-position ↔ ablaut-grade mapping is inverted in the scaffolded chapters.** The authoritative manual (Table 5, [`Talmud-2.1.6.mdx`](https://github.com/gasyoun/SanskritGrammar/blob/main/TolchelnikovTalmud_2026/Talmud-2.1.6.mdx)) and every worked example in [`Talmud-uroky.mdx`](https://github.com/gasyoun/SanskritGrammar/blob/main/TolchelnikovTalmud_2026/Talmud-uroky.mdx) use **Поз. 1 = слабая · Поз. 2 = guṇa · Поз. 3 = vṛddhi**, but [`talmud-02-cheredovanie.mdx`](https://github.com/gasyoun/SanskritGrammar/blob/main/TolchelnikovTalmud_2026/talmud-02-cheredovanie.mdx) (Table 3) and [`onramp/step-2-pozicia-i-tip.mdx`](https://github.com/gasyoun/SanskritGrammar/blob/main/TolchelnikovTalmud_2026/onramp/step-2-pozicia-i-tip.mdx) state Поз. 1 = вриддхи · Поз. 3 = слабая (positions 1↔3 swapped). Affects the AblautMachine widget caption logic too. Left for a human decision (out of H995 answer-key scope).
