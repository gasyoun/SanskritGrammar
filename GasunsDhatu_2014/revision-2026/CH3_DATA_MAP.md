...
- Гигиена: сноска `[^ed24c]` в §2.4 ссылалась на файл с написанием `ZALIZNYAK_…` (через
  `Y`), тогда как файл в репозитории -- `ZALIZNIAK_…` (через `I`): ссылка вела в 404.
  **Исправлено** org-wide broken-link audit fix pass (14-07-2026) -- сноска теперь
  использует верное написание; Гл. 2 при этом не трогали (правка ограничена самой ссылкой).
