...
- **zalizniak-method** (major): Утверждение, что Панини должен был предположить наличие шипящего в корнях *majj* и *bhrajj*, не мотивировано: неясно, идёт ли речь о реконструкции праформы или о графической репрезентации. Отсутствует ссылка на конкретное правило Аштадхьяи.
...
- **zalizniak-method** (major): Фраза «находится вне всяких сомнений» создаёт иллюзию абсолютной достоверности, что не соответствует стилю Зализняка, требующему доказательности, а не риторической уверенности. Кроме того, утверждение о том, что «древнеиндийский язык содержит достаточно верное отражение древней глагольной системы», требует оговорки об известных инновациях (например, презентные основы на -ya-).
...
- **zalizniak-method** (minor): Фраза «некоторые авторитетные ученые утверждают, что их было меньше» не сопровождается конкретными ссылками на работы этих учёных (кроме Cardona). Для стиля Зализняка недопустимо ссылаться на «некоторых» без указания имён и публикаций.
