...
| [commentary_corpus.py](https://github.com/gasyoun/SanskritGrammar/blob/main/GasunsDhatu_2014/revision-2026/commentary_corpus.py) + [secondary_lit.json](https://github.com/gasyoun/SanskritGrammar/blob/main/GasunsDhatu_2014/revision-2026/secondary_lit.json) | H414 the layer **above** panini_sutra.py — backs the `/panini-commentary-corpus` skill: thematic search by **root/concept** (not sūtra number) over Mahābhāṣya + Kātyāyana-vārttika + Kāśikā, `--frame` synth of the commentator frame (school · сутра→вартика→бхашья→Kāśikā chain · who contested · Cardona 1997/Staal 1985/Scharfe 1977 topic pointer), `--biblio` index (12 topics, pointers only). For RWS `lidova-commentary` edits (RWS_REPORT.md §6.7) |
