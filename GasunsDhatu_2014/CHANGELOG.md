...
- **Гибридная RWS-литредактура очереди §1.1/§1.4, §3.1/§3.3/§3.4 — агентский line edit
  ...
  правлено по кластерам RWS-отчета (Д1 понижение бездоказательной модальности — без
  изобретения ссылок; Д2 повествовательные переходы вместо риторических вопросов; Д3
  регистр + опечатки, включая «весьма и весьма», «шесть штук», «вне всяких сомнений»;
  Д4 IAST при первом упоминании: пратишакхья *prātiśākhya*, шабданушасана *śabdānuśāsana*,
  *kāṇḍa*, *seṭ*/*aniṭ*). Точечные фактические исправления: битые после рекомпоновки H991
  кросс-ссылки («2.4. Количество корней» → 2.3; «1.4. Устройство dhātupāṭha» → 2.1),
  год хрестоматии Бётлинка 1945 → 1845 (2×), опечатки имен (Гамкрелидзе, Пальсуле,
  Макдонелл, Тернер, Уленбек, Кашакритсна), дубль-номер заголовка 3.4.1.3 → 3.4.1.4,
  восстановленное отрицание в цитате Беекеса («не в силах восстановить»), «12 лет тому
